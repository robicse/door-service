...
<body>
            ...
            <div class="col-md-4 offset-md-4">
                ...
                <div class="log-form">
                    <form class="form-horizontal" method="post" role="form"
                        action="{{ route('vendor.forget.pass.verify') }}">
                        @csrf
                        <div class="form-group">
                            <label for="forget_code">OTP Code</label>
                            <input type="number" class="form-control" id="forget_code" name="forget_code"
                                id="phone_number" aria-describedby="emailHelp" placeholder="Enter OTP Code ">
                        </div>
    ...
    <script>
        ...
        $('#forget_code').blur(function() {
            ...
            //alert(parent_id);
            var sessionValue = {{ Session::get('forget_otp') }}
            if (forget_code == sessionValue) {
                toastr.success('Your Entered OTP is Matched!')
            } else {
