    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12"
                ...
                <h1 class="header" style="text-align: center;margin-top: 3%">Forget Password</h1>
                <h6 class="header text-white">You can recover your password from here</h6>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 offset-md-4">
                ...
                <div class="log-form">
                    <form class="form-horizontal" method="post" role="form"
                        action="{{ route('vendor.forget.pass.check') }}">
                        @csrf
