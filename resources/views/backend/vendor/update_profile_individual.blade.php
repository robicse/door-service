                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header p-2">
                            @if(count($vendorService) == 0 && $vendor_details->services_area == '')
                                <span class="warningColor">Note: To give your service, Please complete your area field from business info and service info</span>
                            @elseif(count($vendorService) == 0)
                                <span class="warningColor">Note: To give your service, Please complete your service info</span>
                            @elseif($vendor_details->services_area == '')
                                <span class="warningColor">Note: To give your service, Please complete your area field from business info</span>
                            @else

                            @endif
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#personal_info" data-toggle="tab">Personal Info</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#reference" data-toggle="tab">Business info</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#service_info" data-toggle="tab">Service Info</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane " id="gallery">
                                    ...
                                    <div class="timeline timeline-inverse">
                                        ...
                                        <div class="timeline-item mt-3">
                                            <h3 class="timeline-header">Important Document</h3>
                                            <div class="timeline-body">
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="bksearch form-control" name="bksearch"
                                                       value="{{$vendor_details->services_area}}" required>
                                                <div class="bklist">
                                                </div>
                    ...
                    <div class="modal-body">
                        <form action="{{route('vendor.service-selected-by-vendor')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="name">Services</label>
                                    <select class="form-control select2" id="service_sub_category_service_1"  name="service_id[]" multiple="multiple"  style="width: 100%;">
            ...
            $("#service_sub_category").change(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $("#service_sub_category_service_1").html(option);
                    }
                });
            });
