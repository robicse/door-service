                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>{{$key + 1}}</td>
                                <td>
                                    <img src="{{asset('uploads/slider/'.$slider->image)}}" width="80" height="40" alt="">
                                </td>
                                <td>
                                    <a class="btn btn-info waves-effect" href="{{route('admin.slider.show',$slider->id)}}">
                                        <i class="fa fa-eye"></i>
                                    </a>
