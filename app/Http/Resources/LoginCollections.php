...
class LoginCollections extends ResourceCollection
{
        ...
        return [
            'data' => $this->collection->map(function($data) {
                ...
                return [
                    ...
                    'is_vendor_profile' =>  !empty($vendor) ? true : false,
                    'address' =>  !empty($vendor) ? $vendor->address : '',
                    'rating' =>  !empty($vendor) ? 3 : 2,
